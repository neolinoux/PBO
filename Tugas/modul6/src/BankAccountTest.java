            ...
            switch(menu) {
                ...
                case "6" -> {
                    try {
                        ...
                        System.out.println(String.format(" (Pengirim) Saldo akhir objek %s no.rek %s Bank %s adalah Rp.%.2f",
                                        p.get(i-1).getNama(),
                                        noRek,
                                        p.get(i-1).getAkunBank(noRek).getBank(),
                                        p.get(i-1).getAkunBank(noRek).getSaldo()
                                        ));
                        System.out.println(String.format(" (Penerima) Saldo akhir objek %s no.rek %s Bank %s adalah Rp.%.2f",
                                        p.get(x-1).getNama(),
                                        noRekPenerima,
